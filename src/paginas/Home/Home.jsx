...
import CarouselCarta from '../../components/CarouselCarta/CarouselMenu'
...
const Home = ()=>{
  ...
  return(
    ...
    <div className="title-container p-4 d-flex justify-content-center">
      <h2 id='hosteria' className='title m-0'>{t("rooms.title")}</h2>
    </div>

    <section className="container my-md-5 section">
      <div className="row">
          ...
          <div className='container p-4'>
            <div className="row">
              <div className="col-12">
                <h3 className="services text-center">{t("rooms.subtitle")}</h3>
              </div>
            </div>
            <div className="row">
    ...
    <div className="title-container p-4 d-flex justify-content-center">
      <h2 id='restaurante' className='title m-0'>{t("restaurant.title")}</h2>
    </div>
